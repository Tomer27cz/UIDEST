text = """af       Afrikaans             vtt, ttml, srv3, srv2, srv1, json3
...
ht       Haitian_Creole        vtt, ttml, srv3, srv2, srv1, json3
...
nso      Northern_Sotho        vtt, ttml, srv3, srv2, srv1, json3
...
gd       Scottish_Gaelic       vtt, ttml, srv3, srv2, srv1, json3
...
st       Southern_Sotho        vtt, ttml, srv3, srv2, srv1, json3
...
und      Unknown_Language      vtt, ttml, srv3, srv2, srv1, json3
...
fy       Western_Frisian       vtt, ttml, srv3, srv2, srv1, json3
...
if __name__ == '__main__':
    print(text)
    print(lang_dict)
    # inv_map = {v: k for k, v in lang_dict.items()}
    # print(inv_map)
    ...
    #     dict_list.append(tuple(text[i][:-35].rstrip().split()))
    # print(dict_list)
    # lang_dict = dict(dict_list)
    # print(lang_dict)
